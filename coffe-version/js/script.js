...
(function() {
  var Calc, Token, getCharArrayFromObject, isNumber, isString, prepareString, runCalc, setup,
    _this = this,
  ...
  getCharArrayFromObject = function(obj) {
  ...
  prepareString = function(stringToCalc) {
